...
const SKUS = [
  {
    ...
    min_order_qty: 20, reorder_point: 302, min_stock: 280, target_stock: 500, max_stock: 700,
    ...
    physical_stock: 240, reserved_qty: 80, quality_hold_qty: 0, received_days_ago: 53,
  ...
  },
  {
    ...
    min_order_qty: 10, reorder_point: 120, min_stock: 100, target_stock: 280, max_stock: 400,
    ...
    physical_stock: 620, reserved_qty: 40, quality_hold_qty: 0, received_days_ago: 17,
  ...
  },
  {
    ...
    min_order_qty: 5, reorder_point: 85, min_stock: 70, target_stock: 150, max_stock: 220,
    ...
    physical_stock: 185, reserved_qty: 10, quality_hold_qty: 0, received_days_ago: 97,
  ...
  },
  {
    ...
    min_order_qty: 2, reorder_point: 20, min_stock: 15, target_stock: 40, max_stock: 60,
    ...
    physical_stock: 78, reserved_qty: 0, quality_hold_qty: 0, received_days_ago: 189,
  ...
  },
  {
    ...
    min_order_qty: 10, reorder_point: 140, min_stock: 120, target_stock: 280, max_stock: 380,
    ...
    physical_stock: 310, reserved_qty: 60, quality_hold_qty: 0, received_days_ago: 12,
  ...
  },
  {
    ...
    min_order_qty: 20, reorder_point: 190, min_stock: 160, target_stock: 360, max_stock: 500,
    ...
    physical_stock: 420, reserved_qty: 50, quality_hold_qty: 20, received_days_ago: 27,
  ...
  },
  {
    ...
    min_order_qty: 20, reorder_point: 160, min_stock: 140, target_stock: 300, max_stock: 420,
    ...
    physical_stock: 340, reserved_qty: 20, quality_hold_qty: 0, received_days_ago: 109,
  ...
  },
  {
    ...
    min_order_qty: 25, reorder_point: 250, min_stock: 220, target_stock: 480, max_stock: 650,
    ...
    physical_stock: 290, reserved_qty: 30, quality_hold_qty: 0, received_days_ago: 36,
  ...
  },
  {
    ...
    min_order_qty: 15, reorder_point: 130, min_stock: 110, target_stock: 260, max_stock: 360,
    ...
    physical_stock: 275, reserved_qty: 35, quality_hold_qty: 0, received_days_ago: 19,
  ...
  },
  {
    ...
    min_order_qty: 5, reorder_point: 45, min_stock: 35, target_stock: 90, max_stock: 130,
    ...
    physical_stock: 95, reserved_qty: 5, quality_hold_qty: 0, received_days_ago: 58,
...
function seed() {
  ...
  const insSku = db.prepare(`
    INSERT INTO skus (
      ...
      min_order_qty, reorder_point, min_stock, target_stock, max_stock, safety_stock_pct,
      ...
      @min_order_qty, @reorder_point, @min_stock, @target_stock, @max_stock, 20,
      @lead_time_days, @lead_time_std_days, @target_service_level, @demand_cv,
      @unit_cost_sgd, @unit_price_sgd, @annual_carrying_rate_pct, @obsolescence_risk_pct, @max_holding_days, 1
    )`);

  const insPos = db.prepare(`
    INSERT INTO inventory_positions (sku_id, physical_stock, reserved_qty, quality_hold_qty, last_received_date)
    VALUES (@sku_id, @physical_stock, @reserved_qty, @quality_hold_qty, @last_received_date)`);
