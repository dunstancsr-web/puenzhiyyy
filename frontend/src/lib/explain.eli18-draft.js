// ─────────────────────────────────────────────────────────────────────────────
// DRAFT, NOT WIRED IN (TASK-97): concise, plain-English rule-based explanations
//
// A proposed replacement for ./explain.js, written for Stan to review before
// anything in the app changes. Nothing imports this file, so Vite does not
// bundle it. Side-by-side comparison with real figures:
// docs/(Stan) ELI18 EXPLANATIONS DRAFT.md
//
// Same shape and same export as explain.js, so approving it is a one-line
// import change in pages/Alerts.jsx.
//
...
//
// One factual fix over explain.js, found while drafting. Its stockout step
...
// gap is 27. Two true figures, wrongly paired. This draft states each against
  ...
  return [
    {
      ...
      body: para(
        ...
        `That has reached the approved reorder point of ${mt(s.reorder_point_policy)}.`
      ),
    },
    {
      heading: H.how,
