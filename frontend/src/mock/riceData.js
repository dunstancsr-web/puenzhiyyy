...
export const mockSkus = [
  {
    ...
    reserved_qty: 80,
    quality_hold_qty: 0,
    available_stock: 160,      // physical - reserved - hold
    ...
    // Incoming POs
    incoming_stock: 0,
    inventory_position: -140,  // available + incoming - committed demand
  },
  {
    sku_id: "VF-10KG",
  ...
  },
  {
    ...
    velocity_trend: "decelerating",
    days_of_stock: null,        // null = idle, no recent demand
